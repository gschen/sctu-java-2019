...
public class Test2_1 {
    ...
    public static void main(String args[]) {
            ...
            int  n1,n2,n3;
            n1=(int)ch1;n2=(int)ch3;n3=(int)ch3;
            System.out.println("在unicode表中序号"+SQ+ch1+SQ+"对应的序号为"+n1);

            System.out.println("在unicode表中序号"+SQ+ch2+SQ+"对应的序号为"+n2);

            System.out.println("在unicode表中序号"+SQ+ch3+SQ+"对应的序号为"+n3);
