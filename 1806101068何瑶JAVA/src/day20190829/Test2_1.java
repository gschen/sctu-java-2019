...
public class Test2_1 {
    public static void main(String[] args) {
        ...
        System.out.println("在unicode表中序号"+n1+"对应序号的字符为"+SQ+ch1+SQ);
        System.out.println("在unicode表中序号"+n2+"对应序号的字符为"+SQ+ch2+SQ);
        System.out.println("在unicode表中序号"+n3+"对应序号的字符为"+SQ+ch3+SQ);
    }
}
